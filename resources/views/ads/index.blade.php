...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach($ads as $key => $ad)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($ad->expire_at)
                                                        @if(\Carbon\Carbon::parse($ad->expire_at)->isPast())
                                                            <span
                                                                class="text-danger">{{ \Carbon\Carbon::parse($ad->expire_at)->format('d M, Y') }}
                                                                (Expired)</span>
                                                        @else
                                                            <span
                                                                class="text-success">{{ \Carbon\Carbon::parse($ad->expire_at)->format('d M, Y') }}</span>
                                                        @endif
                                                    @else
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" class="btn btn-success preview-ad"
                                                        adid="{{ $ad->id }}" title="Preview Ad"><i class="fa fa-eye"></i></a>
                                                    <a href="{{route('manage-ads.edit', $ad->id)}}" class="btn btn-primary"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="{{route('seller-ads-enquiries', $ad->id)}}"
                                                        class="btn btn-success"><i class="fas fa-envelope"></i></a>

                                                    <a href="{{route('buy-now-enquiries', $ad->id)}}" class="btn btn-success"><i
                                                    ...
                                                    <a href="#" class="btn btn-danger" onclick="confirmDelete({{ $ad->id }})"><i
    ...
    <div class="modal fade" id="preview-ad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    </div>
