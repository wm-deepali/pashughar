                        ...
                        <div class="card-body">
                            <form action="{{ route('master.category.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group " >
                                    ...
                                    <img id="imgView" class="mt-2" src="https://t4.ftcdn.net/jpg/04/70/29/97/360_F_470299797_UD0eoVMMSUbHCcNJCdv2t8B2g1GVqYgs.jpg" alt="Current Image" width="160">
                                </div>
                                ...
                                <div class="form-group"  id="bottomimage" style="display:none">
                                    <label for="bottom_image">Bottom Image</label>
                                    <input type="file" class="form-control" id="bottom_image" name="bottom_image">
                                    <img id="imgViews" class="mt-2" src="https://t4.ftcdn.net/jpg/04/70/29/97/360_F_470299797_UD0eoVMMSUbHCcNJCdv2t8B2g1GVqYgs.jpg" alt="Current Image" width="160">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="canonical_url" name="canonical_url" value="{{ old('canonical_url') }}" required>
                                </div>
