...
@section('content')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#editBlogModal-{{$blog->id}}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <form id="delete-country-{{ $blog->id }}"
                                                    ...
                                                    <a href="#" class="btn btn-danger"
                                                        onclick="confirmDelete({{ $blog->id }})"><i class="fa fa-trash"
                                                    ...
                                                    <div class="modal-content">
                                                        <form method="post" action="{{ route('blogs.update', $blog->id) }}"
                                                            ...
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="editCountryModalLabel">Edit Page
                                                                </h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="edit_title_{{$blog->id}}" name="title"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="slug_{{$blog->id}}" name="slug" placeholder="Slug :"
                                                                        value="{{ $blog->slug }}" required>
                                                                    <small class="form-text text-muted">This will be used in the
                                                                        URL (e.g. /my-blog-title)</small>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea name="detail_content"
                                                                        ...
                                                                        class="w-full border border-gray-400 p-1 bg-white rounded focus:outline-none summernote">{{$blog->detail_content}}</textarea>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="thumb_alt"
                                                                        name="thumb_alt"
                                                                        placeholder="Enter alt text for thumbnail"
                                                                        value="{{$blog->thumb_alt}}">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="banner_alt"
                                                                        name="banner_alt"
                                                                        placeholder="Enter alt text for banner"
                                                                        value="{{$blog->banner_alt}}">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="custom-control custom-switch">
                                                                        <input type="checkbox" class="custom-control-input"
                                                                            id="edit_country_status{{ $blog->id}}" name="status"
                                                                            value="1" {{ $blog->status == 1 ? 'checked' : '' }}>
                                                                        <label class="custom-control-label"
                                                                            for="edit_country_status{{ $blog->id}}">Active</label>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="thumb_alt" name="thumb_alt"
                                placeholder="Enter alt text for thumbnail" value="{{old('thumb_alt')}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="banner_alt" name="banner_alt"
                                placeholder="Enter alt text for banner" value="{{old('banner_alt')}}">
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const addSlug = document.getElementById("slug");

            if (addTitle && addSlug) {
                addTitle.addEventListener("keyup", function () {
                    let slug = addTitle.value.toLowerCase()
                        .replace(/[^a-z0-9]+/g, '-')
                        .replace(/^-+|-+$/g, '');
                    addSlug.value = slug;
                });
            ...
            @foreach($blogs as $blog)
                const editTitle{{$blog->id}} = document.getElementById("edit_title_{{$blog->id}}");
                const editSlug{{$blog->id}} = document.getElementById("slug_{{$blog->id}}");

                if (editTitle{{$blog->id}} && editSlug{{$blog->id}}) {
                    editTitle{{$blog->id}}.addEventListener("keyup", function () {
                        let slug = editTitle{{$blog->id}}.value.toLowerCase()
                            .replace(/[^a-z0-9]+/g, '-')
                            .replace(/^-+|-+$/g, '');
                        editSlug{{$blog->id}}.value = slug;
                    });
                }
            @endforeach
