                            ...
                            <div class="card-body">
                                ...
                                <div id="user-details">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <label class="con-label">Full Name</label><br>
                                            <h3 class="text-con-label">{{ $subscription->customers->full_name ?? '-' }}</h3>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="con-label">Email</label><br>
                                            <h3 class="text-con-label">{{ $subscription->customers->email ?? '-' }}</h3>
                                        </div>
                                        <div class="col-sm-4">
                                            <label class="con-label">Mobile</label><br>
                                            <h3 class="text-con-label">{{ $subscription->customers->mobile ?? '-' }}</h3>
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label class="con-label">Address</label><br>
                                            <h3 class="text-con-label">{{ $subscription->customers->full_address ?? '-' }}
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="subscription-details">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <label class="con-label">Discount Amount(INR)</label><br>
                                            <h3 class="text-con-label">
                                                {{ ($subscription->mrp - $subscription->offered_price) }}
                                            </h3>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <h3 class="text-con-label">{{ $subscription->subscriptions->no_of_ads ?? '' }}
                                            </h3>
                                        </div>
                                        <div class="col-sm-4">
                                ...
                                <div id="payment-details">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <label class="con-label">Paid Amount(INR)</label><br>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            @if($subscription->screenshot != '')
                                                <img class="mt-2 img-fluid"
                                                    src="{{ asset('storage') . '/' . $subscription->screenshot}}"
                                                    alt="screenshot" style="height:70px;">
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <a href="{{route('manage-user-subscriptions')}}" type="button" class="btn btn-secondary"
