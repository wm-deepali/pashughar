                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="d-grid d-md-flex justify-content-md-end m-3">
                                <a href="{{route('subscriptions.index')}}" class="btn btn-outline-primary"><i
                                        class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
                            </div>
                            <div class="card-body">
                                <form action="{{route('subscriptions.update', $result->id)}}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="no_of_ads" name="no_of_ads"
                                                value="{{$result->no_of_ads}}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="subscription_validity">Subscription Validity(In Days)</label>
                                            <input type="number" class="form-control" id="subscription_validity"
                                                name="subscription_validity" required
                                                value="{{$result->subscription_validity}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="ad_validity">Ad Validity(In Days)</label>
                                            <input type="number" class="form-control" id="ad_validity" name="ad_validity"
                                                value="{{$result->ad_validity}}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="mrp">MRP</label>
                                            <input type="number" class="form-control" id="mrp" name="mrp"
                                                value="{{$result->mrp}}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="discount">Discount (%)</label>
                                            <input type="text" class="form-control" id="discount" name="discount"
                                                value="{{$result->discount}}" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="offer_price">Offer Price</label>
                                            <input type="number" class="form-control" id="offer_price" name="offer_price"
                                                value="{{$result->offer_price}}" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="offer_price">Icon</label>
                                            <input type="text" class="form-control" id="icon" name="icon"
                                                value="{{$result->icon}}" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea class="form-control" id="detail" name="detail"
                                                required>{{$result->detail}}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="update_users"
                                                name="update_users" value="1">
                                            <label class="form-check-label" for="update_users">Yes, update all users with
                                                this subscription</label>
                                        </div>
                                    </div>
                                        ...
                                        @if(isset($features) && count($features) > 0)
                                            @foreach($features as $feature)
                                                <div class="subdiv" style="display: flex">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="feature[]" value="{{$feature->feature}}"
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-control" name="is_available[]">
                                                            <option value="1" {{$feature->is_available == 1 ? 'selected' : ''}}>Yes
                                                            </option>
                                                            <option value="0" {{$feature->is_available == 0 ? 'selected' : ''}}>No
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <a href="javascript:void(0);" class="remove_button btn btn-danger"
                                                            title="Remove field"><i class="fa fa-trash"></i> Remove</a>
                                                    </div>
                                            ...
                                            <div class="col-md-4">
                                                <a href="javascript:void(0);" class="add_button btn btn-success"
                                                    title="Add field"><i class="fa fa-plus"></i> Add More</a>
                                            </div>
                                        @else
