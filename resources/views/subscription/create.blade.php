                            ...
                            <form action="{{route('subscriptions.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="subscription_validity" name="subscription_validity" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="ad_validity">Ad Validity(In Days)</label>
                                        <input type="number" class="form-control" id="ad_validity" name="ad_validity" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="float" class="form-control" id="discount" name="discount" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="offer_price">Offer Price</label>
                                        <input type="number" class="form-control" id="offer_price" name="offer_price" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
