                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if($subscription->payment_status == 'Pending')
                                                        <form id="reject-payment-{{ $subscription->id }}"
                                                            action="{{ route('transactions.reject-payment', $subscription->id) }}"
                                                            method="POST" style="display: none;">
                                                            @csrf
                                                            @method('POST')
                                                        </form>
                                                        <a href="#" class="btn btn-danger"
                                                            onclick="confirmReject({{ $subscription->id }})"><i class="fa fa-times"
                                                                aria-hidden="true"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
