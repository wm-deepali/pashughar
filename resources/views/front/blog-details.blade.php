...
@section('metatags')
{!! getDetailsPageMetaTag($blog->meta_title, $blog->meta_keyword, $blog->meta_description, $blog->canonical); !!}
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 m-auto">
                        ...
                        <div class="blog-details-image">
                            <img src="{{ $blog->banner_image ? url($blog->banner_image) : asset('front/images/no-image.jpg') }}" alt="blog-details">
                        </div>
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <ul class="blog-meta">
                                            ...
                                            <li>
                                                ...
                                                <p>{{ $blogshow->created_at ? $blogshow->created_at->format('Y-m-d') : 'N/A' }}</p>
                                            </li>
                                        </ul>
                                        <div class="blog-text">
                        ...
                        <div class="blog-details-comment">
                            ...
                            <ul class="comment-list">
                                ...
                                <div class="form-btn price-btn">
                                    <button type="button" id="load-all-comments" class="btn btn-inline">Load All Comment</button>
                                </div>
                                @endif
                            </ul>
                        </div>
