...
<style>
    ...
    .pgh-icon {
        font-size: 22px;
        color: #4299e1;
        /* blue theme, change kar sakte ho */
        min-width: 24px;
    }
    ...
    @media (max-width: 1200px) {
        .pgh-sub-label {
            display: none;
            /* optional: hide sub-labels on smaller screens */
        }
    }
...
<div class="top_header_list-mobile">
    ...
    <div class="top_vender1" style="display:flex;justify-content:space-between;align-items:center;">
        <p class="mobile-only" data-bs-toggle="offcanvas" href="#dummyOffcanvasExample" role="button"
            aria-controls="dummyOffcanvasExample">
            <span>
                <img src="{{asset('front/images/menu1.png')}}" alt="logo"
                    style="width:25px;margin-left:14px;margin-top: 5px;">
            </span>
        </p>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="dummyOffcanvasExample"
    aria-labelledby="dummyOffcanvasExampleLabel">
    ...
    <div class="offcanvas-body">
        ...
        <ul class="footer-widget" style="color:#000 margin-top:15px;">
            ...
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('user.post-your-ad')}}">Post Free Ads</a></li>
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('list-all-ads')}}">All Ads</a></li>
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('subscription-plan')}}">Pricing Plan</a></li>
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('list-categories')}}">Show All Categories</a></li>
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('user.login')}}">Become Seller</a></li>
            <li style="color:#000; border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"><a
                    style="color:#000" href="{{route('submit-bulk-stock-request')}}">Bulk Order</a></li>
            ...
            @foreach($pages as $page)
                <li @if(!$loop->last) style="border-bottom:1px solid #0000001a; padding-bottom:5px; margin-bottom:5px;"
                @endif>
        ...
        <ul class="footer-address border-top pt-2" style="color:#000;">
            ...
            <ul class="footer-social" style="color:#000; border-top:1px solid #0000001a;">
                <li><a href="https://www.facebook.com/pashughar/"><i class="fab fa-facebook-f"
                            style="color:#000"></i></a></li>
                <li><a href="https://www.instagram.com/pashughar/"><i class="fab fa-instagram"
                            style="color:#000"></i></a></li>

                <li><a href="https://www.youtube.com/@PashuGhar"><i class="fab fa-youtube" style="color:#000"></i></a>
                </li>
            </ul>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="dummyOffcanvasExample1"
    aria-labelledby="dummyOffcanvasExampleLabel">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="dummyOffcanvasExampleLabel">Menu</h5>
        <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    ...
    <div class="offcanvas-body">
        <ul class="user-dashboard-menu">
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.dashboard') ? 'active' : '' }}"
                    href="{{route('user.dashboard')}}"><i class="fa fa-home"></i>&nbsp;Dashboard</a></li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.profile') ? 'active' : '' }}"
                    href="{{route('user.profile')}}"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Profile</a></li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.my-enquiries') ? 'active' : '' }}"
                    href="{{route('user.my-enquiries')}}"><i class="fa-solid fa-clipboard-list"></i>&nbsp;My
                    Enquiries</a></li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.post-your-ad') ? 'active' : '' }}"
                    href="{{route('user.post-your-ad')}}"><i class="fa fa-plus"></i>&nbsp;Ad Post</a></li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.my-ads') ? 'active' : '' }}"
                    href="{{route('user.my-ads')}}"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;My Ads</a>
            </li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.settings') ? 'active' : '' }}"
                    href="{{route('user.settings')}}"><i class="fa fa-cog"></i>&nbsp;Settings</a></li>
            <li><a style="color:gray;text-decoration:none;" class="{{ Route::is('user.my-wallet') ? 'active' : '' }}"
                    href="{{route('user.my-wallet')}}"><i class="fa fa-wallet"></i>&nbsp;My Wallet</a></li>
            <li><a style="color:gray;text-decoration:none;"
                    class="{{ Route::is('user.buy-subscription') ? 'active' : '' }}"
                    href="{{route('user.buy-subscription')}}"><i class="fa-solid fa-money-bill"></i>&nbsp;Buy
                    Subscription</a></li>
            <li><a style="color:gray;text-decoration:none;"
                    class="{{ Route::is('user.my-subscriptions') ? 'active' : '' }}"
                    href="{{route('user.my-subscriptions')}}"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;My
                    Subscriptions</a></li>
            <li><a style="color:gray;text-decoration:none;" href="{{route('user.logout')}}"><i class="fa fa-sign-out"
            ...
            success: function (data) {
                ...
                if (data) {
                    $.each(data, function (index, value) {
                        ...
                        // Build element safely using jQuery, no literal href=" string
                        var $link = $('<a></a>').attr('href', url).text(value.title);
                        var $li = $('<li></li>').append($link);
                        $('.dropdownsearch').append($li);
                    });
                }
            }
        });
