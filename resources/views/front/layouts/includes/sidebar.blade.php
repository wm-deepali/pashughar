  ...
  <aside class="sidebar-part">
      <div class="sidebar-body">
          <div class="sidebar-header">
              <a class='sidebar-logo' href="{{URL::to('/')}}"><img src="{{asset('front/images/logo.png')}}" alt="logo"></a>
          ...
          <div class="sidebar-content">
              ...
              <div class="sidebar-menu">
                  ...
                  <div class="tab-pane active" id="main-menu">
                      <ul class="navbar-list">
                          <li class="navbar-item"><a class='navbar-link' href="{{URL::to('/')}}">Home</a></li>
              ...
              <div class="sidebar-footer">
                  <p>All Rights Reserved By <a href="#">Pashughar.Com</a></p>
                  <p>Developed By <a href="www.webmingo.com">Web Mingo</a></p>
              </div>
          </div>
      </div>
  </aside> 
