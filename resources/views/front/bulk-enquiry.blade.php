                ...
                <div class="tab-pane active" id="register-tab">
                    ...
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" autocomplete="off" name="email" id="email_id_register" value="{{old('email')}}" placeholder="Email"  required>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="tel" onkeypress="return isNumber(event)" autocomplete="off" class="form-control" value="{{old('mobile')}}" name="mobile"  minlength="10" maxlength="10" placeholder="Moblie number" id="phone_number" required>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('telephones')}}" name="telephones" placeholder="Telegram Id (if any)"  required>
                             ...
                             <div class="col-12">
                                <div class="form-group">
                                    <input type="number" class="form-control" value="{{old('order_qty')}}"  name="order_qty"  placeholder="Min. Order Quantity"  required>
                                    <button class="form-icon"></button>
                             ...
                             <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{old('detail')}}" name="detail"  placeholder="Enter Detail"  required>
                                    <button class="form-icon"></button>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="code" value="{{old('code')}}" id="code" placeholder="Enter Zip Code"  required>
