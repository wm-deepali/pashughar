    ...
    <section class="user-form-part">
        ...
        <div class="user-form-category">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input type="email" autocomplete="off" class="form-control" name="email" id="email_id"
            ...
            <div class="tab-pane" id="register-tab">
                ...
                <form id="registerForm" method="post" action="{{ route('user.register') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input type="text" class="form-control" autocomplete="off" name="email"
                                    id="email_id_register" placeholder="Email" required>
                                <small class="form-alert">Please follow this example - abc@example.com</small>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="tel" onkeypress="return isNumber(event)" autocomplete="off"
                                        ...
                                        placeholder="Mobile number" id="phone_number" required>
                                </div>
                                <small class="form-alert">Please enter 10-digit Indian mobile number</small>
                                <span id="mobile-feedback" style="color:red; display:none;"></span>
                            </div>
                        </div>
                        ...
                        @if($adminsetting->is_referral_enable == "1")
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control referralCode" name="referralto"
                                        placeholder="Enter Referral Code">
                                    <span id="errors" style="color:brown"></span>
                                    <input type="text" name="isRef" id="is_valid_refer" value="0" class="form-control"
                                        style="display:none;" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Enter Referral Name" id="names"
                ...
                <div class="user-form-direction">
                    <p>Already have an account? click on the <span><a href="#login-tab" class="nav-link-login"
                                data-toggle="tab">( Sign in )</a></span> button above.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#registerForm').submit(function (event) {
                    ...
                    let mobileFeedback = $('#mobile-feedback');

                    // India mobile number validation (starts with 6-9, 10 digits)
                    let mobilePattern = /^[6-9]\d{9}$/;

                    if (!mobilePattern.test(mobile)) {
                        event.preventDefault();
                        mobileFeedback.text('Invalid Indian mobile number').show();
                    } else {
                        mobileFeedback.hide();
                    }

                    // Email validation
                    let email = $('#email_id_register').val();
                    ...
                    if (recaptchaResponse.length === 0) {
                        // Prevent form submission if captcha not completed
                        event.preventDefault();
                        Swal.fire({
                            icon: 'error',
