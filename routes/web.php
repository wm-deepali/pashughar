...
| be assigned tAo the "web" middleware group. Make something great!
|
*/
...
Route::get('/subscription/{id}/invoice', [App\Http\Controllers\UserController::class, 'downloadInvoice'])
